...
public class ShoppingCartController {
	...
	@PostMapping("")
	public ResponseEntity<ShoppingCart> finalCart(@RequestBody Collection<ProductOrdered> productInOrders,
			Principal principal) {
	...
	@PutMapping("/{itemId}")
	public ProductOrdered modifyItem(@PathVariable("itemId") String itemId, @RequestBody Integer quantity,
			Principal principal) {
		User user = userService.findOne(principal.getName());
