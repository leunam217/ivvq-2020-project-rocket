...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().csrf().disable().authorizeRequests()
				...
				.antMatchers("/cart/**").access("hasRole('ROLE_CUSTOMER')").antMatchers("/order/finish/**")
				.access("hasRole('ROLE_SELLER')").antMatchers("/order/**").authenticated()
				.antMatchers("/seller/product/new").access("hasRole('ROLE_SELLER')").antMatchers("/seller/**/delete")
				.access("hasRole('ROLE_SELLER')").antMatchers("/seller/**").access("hasRole('ROLE_SELLER')")
