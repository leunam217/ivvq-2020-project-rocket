...
public class ProductController {
	...
	public ResponseEntity createProduct(@Valid @RequestBody Product product, BindingResult bindingResult) {
		...
		if (productIdExists != null) {
			bindingResult.rejectValue("productId", "error.product", "Product already exist");
		}
	...
	public ResponseEntity editProduct(@PathVariable("id") String productId, @Valid @RequestBody Product product,
