...
public class ProductOrderedTest {
	...
	void product_id_empty() {
		final ProductOrdered product = new ProductOrdered(
				new Product("", "coucou", new BigDecimal(123), 100, "desc", "icon"), 3);
	...
	void product_name_empty() {
		final ProductOrdered product = new ProductOrdered(
				new Product("B001", "", new BigDecimal(123), 100, "desc", "icon"), 3);
	...
	void product_description_empty() {
		final ProductOrdered product = new ProductOrdered(
				new Product("B001", "coucou", new BigDecimal(123), 100, "", "icon"), 3);
	...
	void product_price_negatif() {
		final ProductOrdered product = new ProductOrdered(
				new Product("B001", "coucou", new BigDecimal(123), -100, "desc", "icon"), 3);
	...
	void get_product_price() {
		...
		final ProductOrdered product = new ProductOrdered(
				new Product("B01", "coucou", new BigDecimal(123), 100, "desc", "icon"), 3);
	...
	void test_not_equals() {
		final ProductOrdered product = new ProductOrdered(
				...
				new Product("B01", "coucou", new BigDecimal(123), 100, "desc", "icon"), 2);
